...
export const metadata: Metadata = {
  ...
  description: "Portfolio of Aviral Sharma, Software Engineer specializing in frontend development with expertise in React, Next.js, and web application design.",
};
